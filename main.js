window.addEventListener('DOMContentLoaded', () => {
    ...
    // Container que engloba os elementos clicáveis (ajuste conforme necessário)
    ...
    async function executeCommands(cmd) {
        ...
        if (cmd.startsWith('cat ')) {
            ...
            if (file === 'contact.txt') {
                ...
                `;
                contentDiv.querySelector('li[data-cmd="cd .."]').addEventListener('click', () => executeCommand('cd ..'));
        ...
        if (cmd.startsWith('ls ')) {
            ...
            `;
            contentDiv.querySelector('li').addEventListener('click', () => executeCommand('ls'));
            return;
        }
    }
    ...
    function renderMenu(items) {
        ...
        contentDiv.querySelectorAll('li').forEach(li => {
            li.addEventListener('click', () => executeCommand(li.dataset.cmd));
        });
    }
